    ...
    final reviewsMap = {
      1: [
        ...
        Review(
          ...
          date: '2 hari lalu',
          comment:
              'Cocok untuk liburan keluarga, pasirnya halus dan aman untuk anak-anak.',
          avatar: 'RM',
          verified: true,
        ),
        Review(
          ...
          date: '1 hari lalu',
          comment:
              'Sunset di sini luar biasa, nggak kalah dari pantai terkenal lainnya!',
          avatar: 'BP',
          verified: true,
        ),
        Review(
          ...
          date: '4 hari lalu',
          comment:
              'Area parkir agak jauh tapi pemandangan sebanding dengan perjalanan.',
          avatar: 'CL',
          verified: true,
        ),
        Review(
          ...
          date: '3 hari lalu',
          comment:
              'Airnya jernih dan spot foto instagramable banget, recommended!',
          avatar: 'DS',
          verified: true,
        ),
      ],
      2: [
        ...
        Review(
          ...
          date: '2 hari lalu',
          comment:
              'Guide-nya informatif, setiap artefak dijelaskan dengan detail.',
          avatar: 'AS',
          verified: true,
        ),
        Review(
          ...
          date: '3 hari lalu',
          comment:
              'Bangunan klasik dan fotogenik, cocok untuk dokumentasi pribadi.',
          avatar: 'LW',
          verified: true,
        ),
        Review(
          ...
          date: '1 minggu lalu',
          comment:
              'Koleksi museum lengkap, suasana tenang dan nyaman untuk belajar sejarah.',
          avatar: 'FH',
          verified: true,
        ),
        Review(
          ...
          date: '4 hari lalu',
          comment:
              'Beberapa spot agak panas di siang hari, tapi worth it untuk dikunjungi.',
          avatar: 'MP',
          verified: true,
        ),
      ],
      3: [
        ...
        Review(
          ...
          date: '2 hari lalu',
          comment:
              'Pemandangan sunrise di puncak luar biasa, jangan sampai kelewatan.',
          avatar: 'RK',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '1 hari lalu',
          comment: 'Trekking menantang tapi jalurnya jelas dan aman.',
          avatar: 'SA',
          verified: true,
        ),
        Review(
          ...
          date: '3 hari lalu',
          comment:
              'Bawa jaket tebal, anginnya kencang di atas, tapi pemandangan sebanding!',
          avatar: 'HP',
          verified: true,
        ),
        Review(
          ...
          date: '5 hari lalu',
          comment:
              'Spot foto banyak dan sangat instagramable, cocok untuk traveler muda.',
          avatar: 'NR',
          verified: true,
        ),
      ],
      4: [
        ...
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Jalur trekking jelas, cocok untuk pemula juga.',
          avatar: 'IP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Pemandangan puncak memukau, sunrise-nya luar biasa.',
          avatar: 'RA',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Bawa air minum banyak karena jalurnya lumayan panjang.',
          avatar: 'DA',
          verified: true,
        ),
        Review(
          ...
          date: '1 hari lalu',
          comment:
              'Spot foto di tebing sangat dramatic, sangat direkomendasikan.',
          avatar: 'AN',
          verified: true,
        ),
      ],
      5: [
        ...
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Sangat bersih dan terawat, cocok untuk belajar sejarah.',
          avatar: 'HG',
          verified: true,
        ),
        Review(
          ...
          date: '1 hari lalu',
          comment:
              'Arsitektur candi menakjubkan, rasanya seperti kembali ke masa lalu.',
          avatar: 'NP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '4 hari lalu',
          comment: 'Spot sunrise di halaman candi cantik banget untuk foto.',
          avatar: 'BS',
          verified: true,
        ),
        Review(
          ...
          date: '2 hari lalu',
          comment:
              'Agak ramai di akhir pekan, tapi masih nyaman untuk dikunjungi.',
          avatar: 'MH',
          verified: true,
        ),
      ],
      6: [
        ...
        Review(
          ...
          date: '2 hari lalu',
          comment:
              'Pedagang ramah, harga wajar, jangan lupa coba jajanan lokal.',
          avatar: 'TH',
          verified: true,
        ),
        Review(
          ...
          date: '1 hari lalu',
          comment:
              'Mal ini lengkap dan bersih, cocok untuk weekend bersama teman.',
          avatar: 'FP',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Suasana malamnya asik, banyak spot foto cantik.',
          avatar: 'NL',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Tempat makan banyak pilihannya, recommended untuk kuliner.',
          avatar: 'AP',
          verified: true,
        ),
      ],
      7: [
        ...
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Airnya tenang dan jernih, cocok untuk piknik keluarga.',
          avatar: 'RM',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Jalur jalan kaki nyaman, banyak spot foto natural.',
          avatar: 'SW',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Sunset di danau ini luar biasa, bawa kamera bagus!',
          avatar: 'BP',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Ramai di akhir pekan, tapi suasananya tetap indah.',
          avatar: 'DA',
          verified: true,
        ),
      ],
      8: [
        ...
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Sedikit berdebu, tapi view kawahnya keren banget.',
          avatar: 'FA',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Jangan lupa bawa jaket karena anginnya dingin.',
          avatar: 'NP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Spot foto epic, terutama saat matahari terbit.',
          avatar: 'RS',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '5 hari lalu',
          comment: 'Sedikit ramai di hari libur, tapi masih nyaman.',
          avatar: 'MS',
          verified: true,
        ),
      ],
      9: [
        ...
        Review(
          ...
          date: '3 hari lalu',
          comment:
              'Guide sangat ramah, menjelaskan sejarah istana dengan detail.',
          avatar: 'AN',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Taman istana luas, cocok untuk anak-anak bermain.',
          avatar: 'CN',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Interior istana indah, banyak spot foto bagus.',
          avatar: 'FP',
          verified: true,
        ),
        Review(
          ...
          date: '4 hari lalu',
          comment:
              'Sedikit ramai di siang hari, tapi pengalaman tetap menyenangkan.',
          avatar: 'RA',
          verified: true,
        ),
      ],
      10: [
        ...
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Bawa kamera, view sunset spektakuler!',
          avatar: 'WA',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Ramai tapi teratur, tetap nyaman untuk jalan-jalan.',
          avatar: 'NP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Pantainya bersih, fasilitas cukup lengkap.',
          avatar: 'IM',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Cocok untuk wisata sore bersama keluarga.',
          avatar: 'PA',
          verified: true,
        ),
      ],
      11: [
        ...
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Koleksi museum lengkap dan informatif.',
          avatar: 'RF',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '1 hari lalu',
          comment: 'Bangunan klasik bagus untuk belajar sejarah.',
          avatar: 'MS',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Guide-nya sangat ramah dan menjelaskan detail sejarah.',
          avatar: 'AG',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Ramai di weekend tapi tetap nyaman untuk berkunjung.',
          avatar: 'CA',
          verified: true,
        ),
      ],
      12: [
        ...
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Pertunjukannya menarik, view laut dan sunset sangat indah.',
          avatar: 'WS',
          verified: true,
        ),
        Review(
          name: 'Ni Putu Lestari',
          rating: 4,
          date: '1 hari lalu',
          comment: 'Agak ramai tapi pengalaman tetap menyenangkan.',
          avatar: 'NP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Kombinasi budaya dan alam yang cantik.',
          avatar: 'MS',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Spot foto di tebing sangat dramatis.',
          avatar: 'KP',
          verified: true,
        ),
      ],
      13: [
        ...
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Udara pagi segar dan view sunrise epik.',
          avatar: 'RS',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Jangan lupa pakai jaket tebal, dingin banget di pagi hari.',
          avatar: 'AN',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Pasir dan panorama Gunung Bromo memukau!',
          avatar: 'SA',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Agak ramai di weekend tapi tetap nyaman.',
          avatar: 'BH',
          verified: true,
        ),
      ],
      14: [
        ...
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Jalur trekking rapi, cocok untuk refreshing.',
          avatar: 'RK',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Airnya bersih, cocok untuk berendam sebentar.',
          avatar: 'FN',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Spot foto alami banyak, sangat instagramable.',
          avatar: 'MP',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Agak licin di musim hujan, hati-hati.',
          avatar: 'AP',
          verified: true,
        ),
      ],
      15: [
        ...
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Bangunan klasik terawat dengan baik.',
          avatar: 'RL',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Spot foto vintage banyak, cocok untuk sejarah.',
          avatar: 'DN',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Ramai di akhir pekan tapi menarik untuk wisata heritage.',
          avatar: 'CS',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '5 hari lalu',
          comment: 'Kombinasi arsitektur dan sejarah sangat kental.',
          avatar: 'AS',
          verified: true,
        ),
      ],
      16: [
        ...
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Suasana klasiknya kuat, cocok untuk foto vintage.',
          avatar: 'RH',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Jendela-jendela tua unik, hati-hati saat berjalan.',
          avatar: 'DP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Atmosfer mistis terasa saat senja, recommended!',
          avatar: 'AN',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Bangunan terawat baik dan bersih.',
          avatar: 'ML',
          verified: true,
        ),
      ],
      17: [
        ...
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Interior gereja megah, sangat menenangkan.',
          avatar: 'RP',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '1 hari lalu',
          comment: 'Pemandangan dari luar juga indah, banyak spot foto.',
          avatar: 'SD',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '4 hari lalu',
          comment: 'Sejarah gereja dan arsitektur sangat memukau.',
          avatar: 'BS',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Agak ramai saat misa tapi tetap nyaman dikunjungi.',
          avatar: 'NL',
          verified: true,
        ),
      ],
      18: [
        ...
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Pemandangan hijau yang menenangkan, cocok untuk meditasi.',
          avatar: 'KS',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '3 hari lalu',
          comment: 'Jalur trekking menyenangkan, udara segar.',
          avatar: 'MP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '2 hari lalu',
          comment: 'Spot foto tradisional sangat Instagramable.',
          avatar: 'NA',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Ramai di akhir pekan tapi tetap indah.',
          avatar: 'WP',
          verified: true,
        ),
      ],
      19: [
        ...
        Review(
          ...
          date: '3 hari lalu',
          comment:
              'Spot snorkeling sangat bagus, ikan dan terumbu karang jelas terlihat.',
          avatar: 'AL',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Pantai agak ramai tapi tetap nyaman.',
          avatar: 'DP',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Airnya jernih, sunset cantik, sangat direkomendasikan!',
          avatar: 'RM',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Cocok untuk keluarga dan anak-anak.',
          avatar: 'BS',
          verified: true,
        ),
      ],
      20: [
        ...
        Review(
          ...
          rating: 5,
          date: '3 hari lalu',
          comment: 'Pemandangan kawah sangat dramatis dan menakjubkan.',
          avatar: 'TH',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '2 hari lalu',
          comment: 'Sedikit berdebu tapi pengalaman tetap seru.',
          avatar: 'RA',
          verified: true,
        ),
        Review(
          ...
          rating: 5,
          date: '1 hari lalu',
          comment: 'Spot terbaik untuk sunrise dan foto landscape.',
          avatar: 'AP',
          verified: true,
        ),
        Review(
          ...
          rating: 4,
          date: '4 hari lalu',
          comment: 'Hati-hati saat mendekati kawah, tapi pemandangan worth it.',
          avatar: 'DS',
          verified: true,
        ),
      ],
